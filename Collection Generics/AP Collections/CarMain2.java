 ...
 * It uses the Iterator to iterate through the ArrayList collection
 * @author Lu Chen
 *
 */
public class CarMain2 {
	...
	public static void main(String[] args) {
		...
		Iterator<Car> iterator = allCar.iterator();
	...
	//this method takes an ArrayList of type Car
	//it displays the attributes of the Car
